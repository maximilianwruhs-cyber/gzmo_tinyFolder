...
import type { InferenceResult, InferDetailedOptions } from "../../../core/platform/inference.ts";
import { readBoolEnv } from "../../../core/pipelines/helpers.ts";
import { DEFAULT_TIMEOUTS } from "../../../core/platform/lifecycle.ts";
...
export async function inferByRole(
  ...
  const { inferDetailed, inferDetailedWithModel } = await import("../../../core/platform/inference.ts");
