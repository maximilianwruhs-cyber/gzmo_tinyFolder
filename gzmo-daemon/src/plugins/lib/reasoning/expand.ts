...
import type { ReasoningNodeType } from "../../../core/shared/reasoning_trace";
import type { InferenceResult } from "../../../core/platform/inference";
import type { ToolCallRecord } from "../../../core/tools/types";
import type { ToolContext } from "../../../core/tools/types";
import type { EmbeddingStore } from "../../../core/rag/embeddings";
import { searchVaultHybrid, type SearchResult } from "../../../core/rag/search";
...
export async function expandAnalyze(
  ...
  systemPrompt: string,
  userPrompt: string,
  inferDetailedFn: (s: string, p: string, o?: import("../../../core/platform/inference").InferDetailedOptions) => Promise<InferenceResult>,
  temp: number,
  maxTok: number,
