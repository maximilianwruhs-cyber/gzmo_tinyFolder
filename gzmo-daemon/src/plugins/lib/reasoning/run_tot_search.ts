...
import { compileEvidencePacket, renderEvidencePacket } from "../../../core/rag/evidence_packet";
import { shapePreservingFailClosed } from "../../../core/rag/response_shape";
import type { ReasoningNode } from "../../../core/shared/reasoning_trace";
import type { EmbeddingStore } from "../../../core/rag/embeddings";
import type { ChaosSnapshot } from "../../../core/shared/types";
...
import { getChatModel } from "../../../core/platform/inference";
import type { InferDetailedOptions } from "../../../core/platform/inference";
import { inferByRole, getChatModelForRole, modelRoutingEnabled } from "../../../plugins/lib/reasoning/inference_router";
import { readBoolEnv, readIntEnv } from "../../../core/pipelines/helpers";
...
import { searchVaultHybrid } from "../../../core/rag/search";
...
export async function runSearchTot(p: RunSearchTotParams): Promise<RunSearchTotResult> {
  ...
  const processRetrievalBranch = async (retrieveNode: ToTNode) => {
    ...
    if (toolChain && toolEnabled) {
      const { discoverFollowUps } = await import("../../../core/tools/chaining");
      const { dispatchTool } = await import("../../../core/tools/registry");
