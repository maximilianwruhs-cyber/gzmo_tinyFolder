...
import matter from "../../../core/platform/yaml_frontmatter.ts";
import type { EmbeddingStore } from "../../../core/rag/embeddings.ts";
import { searchVault, formatSearchContext } from "../../../core/rag/search.ts";
import { atomicWriteJson, safeWriteText, resolveVaultPath } from "../../../core/platform/vault_fs.ts";
import { writeSchemaCompliantWikiPage } from "../../../core/rag/wiki_contract.ts";
import { appendWikiLogEntry } from "../../../core/rag/wiki_log.ts";
import { rebuildWikiIndex } from "../../../core/rag/wiki_index.ts";
import { createAutoInboxTasks, parseTypedNextAction, type AutoTaskSpec } from "../../../core/platform/auto_tasks.ts";
import { assessWikiDraft, quarantineArtifact, createRepairTask } from "../../../core/platform/quarantine.ts";
import { writeOpsOutputsIndex } from "../../../core/rag/wiki_ops_index.ts";
import { compileEvidencePacket, renderEvidencePacket } from "../../../core/rag/evidence_packet.ts";
import { selfEvalAndRewrite } from "../../../core/rag/self_eval.ts";
import { verifySafety } from "../../../core/rag/verifier_safety.ts";
