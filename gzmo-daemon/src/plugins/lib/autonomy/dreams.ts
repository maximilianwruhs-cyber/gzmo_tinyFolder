...
import type { ChaosSnapshot } from "../../../core/shared/types.ts";
import type { EmbeddingStore } from "../../../core/rag/embeddings.ts";
import { searchVault, formatSearchContext, type SearchResult } from "../../../core/rag/search.ts";
import { atomicWriteJson, safeWriteText } from "../../../core/platform/vault_fs.ts";
import { createAutoInboxTasks, parseTypedNextAction, type AutoTaskSpec } from "../../../core/platform/auto_tasks.ts";
import { parseStructuredDreamReflection } from "../../../core/platform/structured.ts";
import { loadAnchorSources, summarizeAnchorFailures, verifyAnchors, type AnchorVerificationResult } from "../../../core/rag/anchor_verifier.ts";
import { REFLECTION_FAILURE_PREMISE, SMALL_MODEL_AUDITOR_RULES } from "../../../core/shared/small_model_rules.ts";
