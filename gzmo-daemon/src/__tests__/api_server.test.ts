...
async function startTestServer(envOverrides: Record<string, string> = {}): Promise<{
  ...
  const mod = (await import(`../api_server${cacheBust}`)) as typeof import("../core/platform/api_server");
  ...
  const mod2 = (await import(`../api_server?p=${port}`)) as typeof import("../core/platform/api_server");
